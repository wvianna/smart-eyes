...
void handleRoot(void) {
  ...
  page += "<p>Longitude: ";
  page += String(lon);
  page += "<p>Informacoes extras: ";
  page += String(extrainfo);
  page += "</p></fieldset>";
...
void formularioBroker(void)
{
  ...
  */
  ...
  if ( strcmp(userC, userConf) == 0 && strcmp(passC, passConf) == 0 )
  {
    ...
    html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>Topico: ";
    html += "<input type=text size=40 name=tMQTT value=" + String(topicoMQTT) + " /></p></fieldset> ";

    html += "<fieldset><legend><b>TAG</b></legend>";
    //html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>TAG: ";
    html += "<input type=text size=40 name=ptag value=" + String(tag) + " /></p></fieldset> ";

    html += "<fieldset><legend><b>Nome</b></legend>";
    //html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>Nome: ";
    html += "<input type=text size=40 name=pname value=" + String(name) + " /></p></fieldset> ";

    html += "<fieldset><legend><b>Latitude</b></legend>";
    //html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>Latitude: ";
    html += "<input type=text size=40 name=plat value=" + String(lat) + " /></p></fieldset> ";

    html += "<fieldset><legend><b>Longitude</b></legend>";
    //html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>Longitude: ";
    html += "<input type=text size=40 name=plon value=" + String(lon) + " /></p></fieldset> ";

    html += "<fieldset><legend><b>Informacoes extras</b></legend>";
    //html += "<header><font size=2> Observacao: Criar topicos com no maximo 40 caracteres. </font></header>";
    html += "<p>Extrainfo: ";
    html += "<input type=text size=40 name=pextrainfo value=" + String(extrainfo) + " /></p></fieldset> ";
